...
const (
	Echo_Say_FullMethodName = "/echo.Echo/Say"
)
...
func (UnimplementedEchoServer) Say(context.Context, *EchoRequest) (*EchoReply, error) {
...
var Echo_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/transport/grpcx/testdata/echo.proto",
}
